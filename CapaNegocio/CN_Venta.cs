...
namespace CapaNegocio
{
    public class CN_Venta
    {
        ...
        {
            return objcd_venta.ObtenerRecaudacionTotal();
        }


        public decimal ObtenerPromedioVenta()
        {
            return objcd_venta.ObtenerPromedioVenta();
        }

        public decimal ObtenerMayorVenta()
        {
            return objcd_venta.ObtenerMayorVenta();
        }

        public decimal ObtenerMenorVenta()
        {
            return objcd_venta.ObtenerMenorVenta();
        }
