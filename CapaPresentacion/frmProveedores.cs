...
namespace CapaPresentacion
{
    public partial class frmProveedores : Form
    {
        ...
        private void frmProveedores_Load(object sender, EventArgs e)
        {
            ...
            {
                int rowIndex = dgvdata.Rows.Add(new object[] {"",item.IdProveedor,item.Documento,item.RazonSocial,item.Correo,item.Telefono,
                    item.Estado == true ? 1 : 0 ,
                    item.Estado == true ? "Activo" : "No Activo"
                });

                //SI EL ESTADO DEL PROVEEDOR ES INACTIVO, PINTAR LAS CELDAS DE GRIS
