...
namespace CapaPresentacion
{
    public partial class frmClientes : Form
    {
        ...
        private void frmClientes_Load(object sender, EventArgs e)
        {
            ...
            {
                int rowIndex = dgvdata.Rows.Add(new object[] {"",item.IdCliente,item.Documento,item.NombreCompleto,item.Correo,item.Telefono,
                    item.Estado == true ? 1 : 0 ,
                    item.Estado == true ? "Activo" : "No Activo"
                });

                //SI EL ESTADO DEL CLIENTE ES INACTIVO, PINTAR LAS CELDAS DE GRIS
